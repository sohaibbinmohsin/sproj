...
const SignUpScreen = () => {
    ...
    return(
        ...
        <View style={styles.root}>
            ...
            <Text style={styles.text}>By resitering, you confirm that you accept our <Text style={styles.link} onPress={onTermsofUsePressed}>Terms of Use</Text> and <Text style={styles.link} onPress={onPrivacyPolicyPressed}>Privacy Policy</Text></Text>
