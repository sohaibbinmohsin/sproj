...
const ChangeUsernameScreen = () => {
    ...
    const [userInitial, setUserInitial] = useState(auth().currentUser.displayName[0])
    ...
    const onChangeUsernamePressed = data => {
        ...
        .then(()=>{
            Alert.alert('Success', 'Your username is changed successfully')
    ...
    return(
        ...
        <View style={styles.root}>
            ...
            />
            <CustomButton text="Change Username" onPress={handleSubmit(onChangeUsernamePressed)} />
